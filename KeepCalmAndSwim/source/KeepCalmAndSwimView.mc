...
class KeepCalmAndSwimView extends Ui.WatchFace {
    var showSecond = true;
    ...
    function onUpdate(dc) {
        ...
        dc.drawText(width_screen/2, height_screen/4, Gfx.FONT_LARGE, "SWIM", Gfx.TEXT_JUSTIFY_CENTER);
        //dc.drawText(width_screen/2, height_screen/4, Gfx.FONT_LARGE, "KeepCalmAndSwim", Gfx.TEXT_JUSTIFY_CENTER);
    ...
    function drawDigitalTime(dc, text_color, clockTime)
    {
        ...
        dc.drawText(width_screen/2, (height_screen/32)*24, font, timeString, Gfx.TEXT_JUSTIFY_CENTER + Gfx.TEXT_JUSTIFY_VCENTER);
    }
